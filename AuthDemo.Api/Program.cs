...
builder.Services.AddAuthorization(op =>
{
    op.AddPolicy(AuthorizationConts.MYPOLICY, p => p.AddAuthenticationSchemes("token").Requirements.Add(new MyAuthorizationHandler("6")));
    op.AddPolicy(AuthorizationConts.MYPOLICY2, p => p.AddAuthenticationSchemes("Cookies").Requirements.Add(new MyAuthorizationHandler2("Wzz")));
});
#endregion
